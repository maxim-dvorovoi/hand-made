jQuery(document).ready(function($){
    ...
    function addProduct(trigger) {
        ...
        var productAdded = $(`<li class="product"><div class="product-image"><a href="/product/${idlist}"><img src="${imglist}" alt="placeholder"></a></div><div class="product-details"><h3><a href="/product/${idlist}">${titlelist}</a></h3><span class="price">${pricelist} грн</span><div class="actions"><a href="#0" class="delete-item" id="${idlist}">Удалить</a></div></div></li>`);
